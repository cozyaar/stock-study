...
export function HomePage({ onPageChange }: HomePageProps) {
  ...
  return (
    <div className="bg-[#050505] text-white relative" ref={containerRef}>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 pb-0 z-10 pointer-events-none">
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 pointer-events-auto">
          <motion.div
          ...
          >
            <motion.div variants={itemVars} className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#22c55e]/30 bg-[#22c55e]/10 backdrop-blur-md shadow-[0_0_20px_rgba(34,197,94,0.15)]">
              ...
              <span className="text-[10px] md:text-xs font-bold text-emerald-300 uppercase tracking-widest">Interactive Cinematic Experience</span>
            </motion.div>
